...
- [x] **Add hyperlinks to the Links page** — done. URLs recovered from the
      pre-migration archive, checked for liveness, and dead ones replaced.
...
- [x] **Add missing officer photos** — done; Pong and Kate's photos are in
      `static/img/team/`.
